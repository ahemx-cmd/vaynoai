  ...
  const plans = [
    {
      ...
      features: [
        "5 AI email generations (one-time)",
        '"Generated by Vayno" watermark',
        "URL-to-Landing Summary – instant product analysis",
    ...
    },
    {
      ...
      features: [
        isLifetime ? "Unlimited email generations (lifetime)" : "50 AI email generations / month",
        "Remove watermark",
        "Everything in Free",
        "Priority AI speed"
      ],
      ...
      checkoutUrl: isLifetime 
        ...
        : "https://vayno.lemonsqueezy.com/buy/b8a3207d-80e9-4092-8cfc-5f15c00511b1?logo=0"
    },
    {
      name: "Pro",
      price: "$19",
      ...
      features: [
        ...
        "Batch Campaigns (upload multiple URLs)",
