  ...
  const plans = [
    {
      ...
      features: [
        "3 email generations / month + 2 bonus for new users",
    ...
    },
    {
      ...
      period: isLifetime ? "one-time" : "month",
      icon: CreditCard,
      color: "from-primary to-accent",
      popular: true,
      showToggle: true,
      features: [
        isLifetime ? "50 email generations / month (lifetime access)" : "50 email generations / month",
        "Remove watermark",
        "Smart Preview",
        "Priority AI speed",
        "Everything in Free",
